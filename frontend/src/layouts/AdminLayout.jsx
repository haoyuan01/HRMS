...
import {
  ...
  Receipt, ChevronDown, LogOut, Bell, Menu, X,
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/admin/leave',      label: 'Leave Management',   icon: FileText        },
  { to: '/admin/expenses',   label: 'Expense Management', icon: Receipt         },
]
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="h-16 flex items-center px-6 gap-3 flex-shrink-0">
        ...
        <span className="ml-auto text-[10px] font-inter font-semibold uppercase tracking-widest text-on_surface_variant bg-surface_container px-2 py-0.5 rounded">Admin</span>
        {!isDesktop && (
    ...
    <div className="flex h-screen bg-surface overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        >
          ...
          <button className="w-9 h-9 rounded-md flex items-center justify-center hover:bg-surface_container_high transition-colors relative flex-shrink-0">
